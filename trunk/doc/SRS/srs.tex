...
\begin{document}
	% Tabla de cambios
	\begin{tablacambios}
		1 & 15 de Noviembre de 2012 & \begin{tabular}{l}Cristina Alonso\\Natalia Angulo\\Sandra Bermejo\\Juan Andrés Claramunt\\Rubén Rafael Rubio \\\textit{(Todo el grupo)}\end{tabular} & Realización completa de la Introducción al proyecto.
	\end{tablacambios}
