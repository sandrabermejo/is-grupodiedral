 ...
 \\
	...
	\section{Documentación} % Natalia
		\subsection{Propósito}
			...
			%N: Más o menos así?
			El propósito de la documentación generada por las revisiones del proyecto es sobre todo proporcionar una consistencia y calidad a éste. Además, se identificarán los documentos regulados en las diferentes fases del proyecto y se indicarán los que necesiten una revisión.\\ %¿Sólo una?N:No se me ocurre más!
		...
		\subsection{Requisitos mínimos de documentación}
			...
			%N:así Corregido?
			La documentación mínima requerida para el proyecto que se está desarrollando es: SRS, especificación de diseño, plan de proyecto, plan de verificación y validación y el documento con dichos resultados, plan de Gestión de Calidad y documentación de usuario.\\
...
coherente en todos los documentos generados y que no haya por tanto partes contradictorias; comprobar que se van cumpliendo tal y como se indican todos los requisitos detallados y que se sigue el modelo de documentación especificado (estándares, normas de documentación...), es decir, que la información es verificable; y por último, la información debe ser completa, esto es, no debe quedar ningún elemento sin especificar y debe cumplir todo lo acordado con el cliente.
		...
		\subsection{Otra documentación}
			...
			\begin{itemize}
				...
				\item Plan de mantenimiento del Software
			\end{itemize}
