...
\begin{document}
	% Tabla de cambios
	\begin{tablacambios}
		2.5 & 5 de marzo de 2013 & Todos & Versión inicial \\ \hline
		3.0 & 21 de marzo de 2013 & NAH, SBC, RRC & Tercera entrega
	\end{tablacambios}
...
Para los distintos documentos se han creado plantillas en {\rmfamily\LaTeX{}}, a partir de las cuales generar los documentos a entregar a nuestro cliente.\\
 ...
 y contar con el permiso los integrantes del equipo de desarrollo.\\
	...
	\section{Formación} % Natalia
		Con el fin de asegurar los objetivos de calidad del proyecto, los desarrolladores deberán contar con cierto grado de experiencia previa en programación. Además durante el desarrollo del proyecto deberán cursar una serie de actividades formativas reguladas:
		
		\begin{enumerate}
			\item La asignatura \textit{Ingeniería del Software} (9 ECTS), con el fin de aprender las técnicas necesarias para el desarrollo de sistemas \software .
			\item La asignatura \textit{Tecnología de la Programación} (12 ECTS), para introducirse en los conceptos y técnicas de la programación orientada a objetos.
		\end{enumerate}

		Igualmente durante el transcurso del proyecto y puntualmente se realizarán actividades de formación con el objetivo de:

		\begin{itemize}
			\item Enseñar a manejar las herramientas CASE de utilidad en el proyecto.
			\item Dotar a los miembros de un conocimiento suficiente del sistema tipográfico {\rmfamily \LaTeX\ } para poder elaborar la documentación, así como instruirles en el uso de las macros elaborados para la documentación del proyecto.
		\end{itemize}

			Estas actividades se planificarán cuando las circunstancias lo demanden.
