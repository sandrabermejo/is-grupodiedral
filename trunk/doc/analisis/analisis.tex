...
\end{landscape}
		...
		\subsection{Diagramas de actividad}
			\subsubsection{Acceder web}
				\begin{figure}[H]\centering
%					\includegraphics[scale=.75]{diagramas/da_accederweb.pdf}
				\end{figure}
...
%					\includegraphics[scale=.72]{diagramas/da_comprarbillete.pdf}
			...
			\subsubsection{Consultar oferta}
				\begin{figure}[H]\centering
%					\includegraphics[scale=.85]{diagramas/da_consultaroferta.pdf}
				\end{figure}
...
%					\includegraphics[scale=.8]{diagramas/da_registrarse.pdf}
			...
			\subsubsection{Restablecer contraseña}
				\begin{figure}[H]\centering
%					\includegraphics[scale=.77]{diagramas/da_restablecercontrasena.pdf}
				\end{figure}
