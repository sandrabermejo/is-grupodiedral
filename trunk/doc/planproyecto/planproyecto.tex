...
\usepackage{float}
\usepackage{lscape}
% Rota las páginas apaisadas en el pdf
...
\begin{document}
	...
	\section{Estimaciones del proyecto}
		...
		\subsubsection{Cálculo de los puntos de función}
			De acuerdo a lo indicado en la apartado anterior \textit{\nameref{estimac:factores}}, el factor de complejidad total, que hemos calculado de forma global, suma 44.\\
	...
	\begin{table}[H] \centering
		\begin{tabu} to .6\linewidth {| X[3, l] | X[1, r] |}
			\hline
			\nameref{estimac:gestioncorriente} & 139\\ \hline
			\nameref{estimac:configuracion} & 59\\ \hline
			\nameref{estimac:iexterna} & 74\\ \hline
			\nameref{estimac:iinterna} & 138\\ \hline
			\nameref{estimac:graficas} & 14\\ \hline
			\nameref{estimac:analisis} & 75\\ \hline
			\multicolumn{1}{|r|}{Total} & 499 \\ \hline
		\end{tabu}
	...
	\section{Estrategia de gestión del riesgo}
		...
		\subsection{Estudio de los riesgos}
			...
			% El orden de los riesgos responde a su encaje en la maquetación
			% Sin embargo, en primer lugar aparecen los riesgos intolerables
