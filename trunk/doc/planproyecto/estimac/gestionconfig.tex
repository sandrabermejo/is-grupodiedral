...
\estimacionfunc	% Ficheros Lógicos Internos
{
	...
	\estfli{Modelos de avión}{
		\rets{1}{técnicos}
		\dets{15}{fabricante, nombre modelo (2) (versión y serie), número de avion, plazas,\break dimensiones, capacidad bodega, coste, año fabricación, estado, tipo de combustible, consumo medio, autonomía, peso del avión, motores}
	}{baja}

	\estfli{Países}{
		\rets{1}{geográficos}
		\dets{7}{nombre, código ISO, capital, idiomas oficiales, población, moneda, huso horario}
	}{baja}
