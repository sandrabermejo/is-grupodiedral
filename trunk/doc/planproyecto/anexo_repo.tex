...
\begin{enumerate}
	...
	\reporev{Subo mis tres casos de uso que me tocaron}{NAH}{24.11.2012}
	\reporev{Borrador de 2 casos de uso. Inclusión de los casos de uso en el documento}{RRC}{25.11.2012}
	\reporev{Subidos casos de uso crearnomina.tex y programarrevision.tex y actualizado casosdeuso.tex}{JCP}{25.11.2012}
	\reporev{Dos casos de uso Gestión Externa (PresentarReclamaciones.tex y realizarPagoBilletes.tex)}{NAH}{28.11.2012}
	...
	\reporev{Subida tabla verinfovuelo.tex}{JCP}{10.12.2012}
	...
	\reporev{Modificados mis casos de uso que hice y he vuelto a subir los diagramas/casosgi.svg pues no los había subido correctamente}{NAH}{12.12.2012}
	\reporev{Nuevos casos de uso de gestión externa}{NAH}{12.12.2012}
	\reporev{Vuelvo a subir el diagramas/casosgi.svg pues he añadido un caso de uso que se nos había olvidado ponerlo (crear nómina). Además he hecho el diagramas/CASOSGE.svg. Divido el CU de realizar pago en tres partes}{NAH}{12.12.2012}
	...
	\reporev{Orden alfabético en casosdeuso.tex. Arreglados errores}{RRC}{12.12.2012}
	...
	\reporev{He modificado casosgi.svg poniendo una flechita del directivo al nuevo caso de uso "ConsultarFichaEmpleado.tex". Además lo he hecho según he pensado que lo habíamos puesto. He modificado también el casosdeuso.tex incluyendo este nuevo caso de uso}{NAH}{13.12.2012}
	\reporev{Corregido error de sintaxis en consultarplandevuelo.tex}{NAH}{13.12.2012}
	...
	\reporev{Nuevos casos de uso: ddar de baja cliente y configurar sistema general}{NAH}{15.12.2012}
	\reporev{Revisados casos de uso: comprarBillete.tex, consultarInventario.tex, consultarFichaEmpleado.tex, configurarNomina.tex; y añadidos: introducirPlanDeVuelo.tex, efectuarEmbarque.tex}{SBC}{15.12.2012}
	\reporev{Casos de uso revisados: editarInformacionEconomica.tex, IniciarPagoBilletesDeVuelo.tex, ModificarItemsInventario.tex, programarHorarios.tex, realizarPagoconTarjeta.tex, registrarEmpleado.tex, verificarRegistroEmpleado.tex. He eliminado pago con PayPal pues no es frecuente en compra de billetes de vuelo}{CAF}{15.12.2012}
	\reporev{Cambio de nombres [erróneo]}{CAF}{15.12.2012}
	\reporev{Revisiones y añadidos dos casos de uso}{JCP}{15.12.2012}
	\reporev{Renombrados que me causaban conflicto [ver r35]}{JCP}{15.12.2012}
	...
	\reporev{SRS de mis casos de uso (llevan el nombre del caso de uso al que corresponden con un SRS delante). Los subo aparte por no agrandar tanto el srs.tex (de momento...)}{CAF}{16.12.2012} % r40
	...
	\reporev{Perdón, es este, que lo he modificado para que compile pues había unos pequeños fallos por unas comas}{NAH}{16.12.2012}
	...
	\reporev{Archivos .h .cpp y .ui de las ventanas de mis casos de uso de Gestión Interna (modificarItemsInventario, registrarEmpleado, verificarRegistroEmpleado, programarHorarios y editarInformacionEconomica)}{CAF}{17.12.2012} % r60
	...
	\reporev{Añadidos.cpp, .h y .ui de: consultar inventario, consultar ficha empleado, dar de baja empleado, configurar nómina, introducir plan de vuelo y efectuar embarque}{SBC}{17.12.2012}
	\reporev{Añado también el formato .png de las pantallitas}{SBC}{17.12.2012}
	\reporev{Especificación de requisitos de mis casos de uso}{SBC}{17.12.2012}
	\reporev{Implementación fea del prototipo. Ya no subáis más pantallas}{RRC}{18.12.2012}
	\reporev{añadidas algunas imágenes al documento srs.tex}{NAH}{18.12.2012}
	...
	\reporev{He quitado un comentario que ya no tenía sentido pues estaba modificado}{NAH}{19.12.2012}
	\reporev{Subo el prototipo web con todo más o menos hecho de forma chapucera}{NAH}{19.12.2012}
	\reporev{Resubo Realizar pago final.html que se me había colado uno viejo}{NAH}{19.12.2012}
	\reporev{Subo el SRS compilado con todos los archivos que genera a petición de Juan Andrés}{NAH}{19.12.2012}
	\reporev{He añadido a la SRS: 1.5- resumen, 2.5- supuestos y dependencias, 3.3- requisitos de rendimiento}{SBC}{19.12.2012}
	...
	\reporev{Mejorada considerablemente la apariencia de los diagramas de la presentación. Logo plagiado transparente}{RRC}{19.12.2012}
	...
	\reporev{Ligera modificación en la web (logo sin fondo) y tabla de vuelos de Cuenca y Barcelona modificadas las terminales (pues ponía Madrid por error)}{NAH}{19.12.2012}
	\reporev{Ay que me he equivocado al subirlo. ¡Este! ¡Este!}{NAH}{19.12.2012}
	...
	\reporev{Arreglados los conflictos con el commit de Natalia. Salen 35 casos de uso, antes de salían 34. Latex dice que no hay repes}{RRC
}{20.12.2012}
	...
	\reporev{Subo los casos de uso revisados de Personal de Recursos Humanos y Directivos. Solo casos de uso. Próximamente SRS. Continuará...}{NAH}{25.12.2012}
	...
	\reporev{se me olvidaba una cosa...}{SBC}{26.12.2012}
	\reporev{Revisión navideña de los SRS: acceder.tex, configurarNomina.tex, consultarFichaEmpleado.tex, consultarHorarios.tex, consultarNomina.tex, darDeBajaEmpleado.tex, obtenerInfoEconomica.tex, registrarEmpleado.tex, verificarRegistroEmpleado.tex. He añadido a cada SRS un nuevo item como hizo Rubén que indica la prioridad de la función}{NAH}{27.12.2012} % r100
	\reporev{Revisado en srs.tex: Resumen, Características del usuario (modificado algo muy mínimo) y supuestos y dependencias (he añadido un párrafo)}{NAH}{27.12.2012}
	...
	\reporev{Revisión de mis casos de uso y sus SRS correspondientes. Destaco un par de cosas: - añadido caso de uso ``realizar mantenimiento '' (que para el mecánico luego redirige a ``modificar items inventario'', como apuntaba Rubén en el pdf) - dividido el antiguo caso de uso ``efectuar embarque'' en dos: ``facturar'' y ``realizar embarque''}{CAF}{4.1.2013}
	...
	\reporev{Añadidas funciones Realizar mantenimiento y Facturar, así como pequeños cambios en mis SRS generales: 2.1 Perspectiva del producto. 2.5 Supuestos y dependencias}{CAF}{4.1.2013} % r110
	...
	\reporev{Subido riesgos/Inactividad por periodo examenes.tex. Duda en la parte de autor/departamento que realiza el riesgo}{NAH}{19.2.2013}
	\reporev{Repito lo anterior que no lo he subido\ldots pequeño fallo}{NAH}{19.2.2013}
	\reporev{Un nuevo riesgo. riesgos/Softwarenoreutilizable.tex}{NAH}{19.2.2013} % r120
	\reporev{Corregidos algunos fallos}{NAH}{19.2.2013} % r120	
	\reporev{Última tablita de riesgos/Faltacomunicacioncliente.tex que le faltaba a Nata. Comentamos algunas dudas mañana}{NAH}{19.2.2013}
	\reporev{Cambio mínimo de acuerdo a la correción}{RRC}{19.2.2013}
	\reporev{planproyecto.tex modificado. Hay cosas que hay que revisar mañana}{NAH}{20.2.2013}
	\reporev{Mis 3 riesgos. Cambios en obsolescencia de tecnologias utilizadas en: - Impacto de N a M - Probabilidad de M a B}{CAF}{20.2.2013}
	\reporev{Plan de proyecto actualizado}{CAF}{20.2.2013}
	\reporev{Subidos otros 3 riesgos y añadidos en planproyecto.tex}{SBC}{20.2.2013}
	...
	\reporev{riesgos ensamblar}{JCP}{21.2.2013}
	\reporev{Lista de materiales y otros cambios}{RRC}{21.2.2013}
	\reporev{Pequeñas modificaciones en riesgos y añadido nuevo riesgo desconocimientotecnologias.tex}{CAF}{22.2.2013}
