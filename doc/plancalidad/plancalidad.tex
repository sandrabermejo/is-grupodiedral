...
Para los distintos documentos se han creado plantillas en {\rmfamily\LaTeX{}}, a partir de las cuales generar los documentos a entregar a nuestro cliente.\\
 ...
 Además servirán para poder establecer una \gls{linea_base} entre el cliente y los desarrolladores. 
		...
		\begin{center}
				...
				1ª Reunión & 13/03/2013 & Actas de las reuniones & Todos los miembros del Grupo Diedral	\\ 
									 & 						& Desarrollo de las revisiones &	\\	\hline
				\end{tabular}
			\end{center}
	...
	\section{Informe de errores y acciones correctoras} % Sandra
		En este apartado especificamos la metodología que vamos a utlilizar para la elaboración de informes de errores y el procedimiento que se va a seguir para tomar acciones correctoras. \\
		...
		Por último, se elaborarará un \textit{Acta de la Revisión Técnica Formal} de cada documento generado (Casos de Uso, Especificación de Requisitos y Plan de Proyecto), en el que se detalla quiénes llevaron a cabo la revisión, dónde y cuándo, así como los errores encontrados por orden de aparición y las soluciones adoptadas por parte del Grupo Diedral. En este acta se incluye el anexo elaborado por el equipo revisor.
