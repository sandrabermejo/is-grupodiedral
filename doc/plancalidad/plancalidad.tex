...
Para los distintos documentos se han creado plantillas en {\rmfamily\LaTeX{}}, a partir de las cuales generar los documentos a entregar a nuestro cliente.\\
 ...
 y contar con el permiso los integrantes del equipo de desarrollo.\\
	...
	\section{Formación} % Natalia
		La formación previa que tienen que tener los desarrolladores del proyecto para satisfacer y realizar correctamente el Plan de Calidad son:
		...
		\begin{enumerate}
			...
			\item Actividades formativas que provean de conocimiento de las herramientas de desarrollo ligadas a la Ingeniería del Software.
		...
		Por otra parte, las actividades formativas que el equipo de desarrollo ha planificado para que se aprenda a elaborar partes del proyecto son: \\
		\begin{itemize}
			\item Reuniones entre los miembros del equipo para la puesta en común de conocimientos sobre la elaboración del proyecto.
			\item Reparto de trabajo en subgrupos para facilitar la comunicación y mejorar el rendimiento. Su objetivo principal será la ayuda de unos miembros con otros de un mismo subequipo.
			\item Pequeñas reuniones con el profesor para la resolución de dudas a cerca de una parte a desarrollar del proyecto.
		\end{itemize} %Rubén, no tengo imaginación en este punto...
