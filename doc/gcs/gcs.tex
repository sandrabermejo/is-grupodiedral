...
\begin{document}
	...
	\section{Introducción}%natalia
		...
		\subsection{Referencia}
			\begin{itemize}
				\item \textit{IEEE Standard for Software Configuration Management Plans 828-1998.}
			...
			En la siguiente sección se va a realizar la Identificación, nombrado y adquisición de \gls{ECS}.
				...
				\begin{enumerate}
					\item \textit{\textbf{Descripción.}}
						...
						\end{itemize}
					\item \textit{\textbf{Lista de recursos.}}
				...
				Completar.
				\subsubsection{Otros}
			Algunos ECS importantes que no se van han desarrollado aún y que por tanto no se van a detallar en este documento son: Diagramas de colaboración de análisis, el documento de diseño, el manual de usuario, el plan de pruebas del sistema, documentos de diseño de base de datos, especificaciones de prueba del sistema...	
