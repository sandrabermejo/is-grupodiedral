...
\hojariesgo{Errores estructurales en el diseño del proyecto}{
	...
	% Descripción
	descripcion={Se han cometido errores en la fase de diseño, por lo que el equipo de desarrollo tendrá que volver a atrás; retrasando así distintas tareas y disminuyendo el rendimiento del proyecto.},
	...
	contingencia={En caso de haber detectado errores en el diseño del proyecto, se procederá a la modificación del mismo, tratando de reutilizar en la mayor medida posible las partes que ya teníamos y que no causaban conflicto en el diseño.},
