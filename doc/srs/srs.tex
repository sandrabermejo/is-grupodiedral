	...
	\section{Requisitos específicos}
		...
		\subsection{Requisitos lógicos de la base de datos}
			...
			\begin{itemize}
				...
				Además, especificando en el ámbito de programación, algunas funciones como \nameref{fun:modinventario}, \nameref{fun:EntrMat} y \nameref{fun:consultarinventario} (entre otras), tendrán que manejar objetos de una ``clase Item'' para poder trabajar con ellos en la base de datos y almacenarlos ahí en \gls{arrays}. 
