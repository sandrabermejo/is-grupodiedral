...
\begin{document}
	...
	% Fija cita inicial
	\fijacitainicial{Viajar por el hiperespacio no es dar un paseo por el campo, niño...}{Hans Solo, Star Wars: Una Nueva Esperanza}
	...
	\include{casos/realizarMantenimiento}
	...
	\include{casos/consultarVuelos}
	\include{casos/mostrarofertas}
	\include{casos/accederaUnaOferta}
